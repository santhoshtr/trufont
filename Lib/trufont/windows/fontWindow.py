...
class FontWindow(BaseWindow):
    ...
    def paste(self):
        ...
        if mimeData.hasFormat("application/x-trufont-glyph-data"):
            ...
            if len(glyphs) == 1:
                ...
                try:
                    glyphContentToPaste = self._svg2glif(
    ...
    def _svg2glif(self, svg, name, width=0, height=0,
                  unicodes=None, transform=None, version=2):
        ...
        conversion (must be tuple of 6 floats, or a FontTools
        Transform object).
        """
